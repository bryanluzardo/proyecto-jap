...
export function initCategories(){
  ...
  if (sortByCountBtn) sortByCountBtn.addEventListener("click", function(){
    sortAndShowCategories(ORDER_BY_PROD_COUNT);
  });

  const clearRangeFilterBtn = document.getElementById("clearRangeFilter");
  if (clearRangeFilterBtn) clearRangeFilterBtn.addEventListener("click", function(){
  ...
  if (applyRangeFilterBtn) applyRangeFilterBtn.addEventListener("click", function(){
